...
export default class AtomicSwap {
  /**
   *
  ...
  constructor(params = {}) {
    ...
    this.buildClaimTransaction = this.buildClaimTransaction.bind(this);
    this.buildHoldingAccountTransaction = this.buildHoldingAccountTransaction.bind(this);
    this.buildMoveAssetToHoldingAccountTransaction = this.buildMoveAssetToHoldingAccountTransaction.bind(this);
    this.makeHashlock = this.makeHashlock.bind(this);
    this.makeHoldingKeys = this.makeHoldingKeys.bind(this);
  }
